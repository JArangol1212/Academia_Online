...
export function InfoCourse(props:InfoCourseProps){
      ...
      const {chapterCourseId,infoCourse,purchaseCourse,userProgress, videoUrl} = props
            ...
            <div className="w-full relative">
                  {!purchaseCourse && (
                         ...
                         backdrop-blur-md gap-y-2 h-full z-30 rounded-md text-secondary">
                              ...
                              <p className="text-sm">Capitulo bloqueado. Paga el curso para desbloquearlo</p>
                  ...
                  {videoUrl  && (
                   ...
                   <ProgressCourse userProgress={userProgress}
